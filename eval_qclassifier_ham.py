...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=5,
        type=int,
        help="Number of qubits. Must match the training configuration. (default: 5 for hamiltonian)",
    )
    parser.add_argument(
        "--n_layers",
        default=2,
    ...
    else:  # qclassifier hamiltonian
        from quantum_models.make_model_qclassifier_ham import make_model
        model = make_model(
            cfg,
            num_class=num_classes,
            camera_num=camera_num,
