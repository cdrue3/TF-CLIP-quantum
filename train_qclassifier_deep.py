...
from quantum_models.classification.make_model_qclassifier_deep import make_model
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="TF-CLIP Deep Quantum Classifier Training (n_qubits=10, n_layers=4)")
    ...
    parser.add_argument("--gradient_clip", default=1.0, type=float,
        help="Gradient norm clipping (barren plateau mitigation, default 1.0).")
    parser.add_argument(
        "opts",
