...
Training script for the TF-CLIP Light Re-uploading Temporal Quantum Aggregation (TQA) variant.
...
from quantum_models.feature_extraction.make_model_qtemporal_reupload import make_model
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="TF-CLIP Light Re-uploading Temporal Quantum Aggregation Training")
    ...
    parser.add_argument(
        ...
        default=4,
        type=int,
        help="Number of independent VQC weight blocks in re-uploading circuit (default: 4).",
    )
    parser.add_argument(
        "--classical_ablation",
        action="store_true",
