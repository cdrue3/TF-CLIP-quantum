...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="TF-CLIP Quantum Image Preprocessing Training")
    ...
    parser.add_argument(
        ...
        default="qpca",
        choices=["qpca", "qpie"],
        help="Preprocessing mode: qpca=channel VQC, qpie=spatial grid VQC.",
    )
    parser.add_argument(
        "--n_qubits",
        default=4,
        type=int,
        help="Number of qubits in the preprocessing VQC. (default: 8)",
    )
    parser.add_argument(
        "--n_layers",
        default=1,
        type=int,
        help="Number of variational entangler layers. (default: 2)",
    )
    parser.add_argument(
        "--classical_ablation",
        action="store_true",
