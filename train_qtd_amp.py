...
from quantum_models.make_model_qtd_amp import make_model
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="TF-CLIP QTD Amplitude Encoding Training")
    ...
    logger.info(
        f"[QTD-Amp] n_qubits={args.n_qubits}, n_layers={args.n_layers}, "
