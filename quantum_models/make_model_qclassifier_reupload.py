...
from quantum_models.amplitude.quantum_classifier_reupload import QClassifierReupload
...
class build_transformer(nn.Module):
    ...
    def __init__(self, num_classes, camera_num, view_num, cfg,
        ...
        print(
            f"[QClassifierReupload] n_qubits={n_qubits}, n_layers={n_layers}, seq_len={cfg.INPUT.SEQ_LEN}  "
...
def make_model(cfg, num_class, camera_num, view_num,
               ...
               bypass_quantum: bool = False, preprocess: str = 'none'):
    model = build_transformer(
        num_class, camera_num, view_num, cfg,
        n_qubits=n_qubits, n_layers=n_layers,
        bypass_quantum=bypass_quantum, preprocess=preprocess,
    )
    return model
