...
---------------------------------------
- QuantumTemporalConfigurable replaces the mean-pool temporal aggregation in the primary path:
...
from quantum_models.optimisation.quantum_temporal_configurable import QuantumTemporalConfigurable
...
class build_transformer(nn.Module):
    ...
    Differences from make_model_adapter.py:
        - tqa: QuantumTemporalConfigurable — replaces img_feature.mean(1) in the primary path.
    ...
    def __init__(self, num_classes, camera_num, view_num, cfg,
                 ...
                 entanglement: str = "full", bypass_quantum: bool = False):
        super().__init__()
        ...
        # ------------------------------------------------------------------ #
        self.tqa = QuantumTemporalConfigurable(
        ...
        print(
            f"[TQA] n_qubits={n_qubits}, n_layers={n_layers}, seq_len={cfg.INPUT.SEQ_LEN}  "
...
def make_model(cfg, num_class, camera_num, view_num,
    ...
    Returns:
        build_transformer instance with QuantumTemporalConfigurable + classical classifier heads.
    """
