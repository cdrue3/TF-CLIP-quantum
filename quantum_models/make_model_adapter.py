"""
quantum_models/make_model_adapter.py

TF-CLIP model variant — Shared VQC Adapter (residual feature transform).

What changed vs. make_model_qclassifier.py
-------------------------------------------
- A single shared QuantumAdapter is inserted BEFORE the primary bottleneck BN.
  It adapts `img_feature` (the temporal-mean CLS-token feature, 768-dim) via
  a residual quantum transform:
      img_feature_adapted = img_feature + upscale(VQC(pre_net(img_feature)))
...
class build_transformer(nn.Module):
    ...
    def __init__(self, num_classes, camera_num, view_num, cfg,
        ...
        self.quantum_adapter = QuantumAdapter(
            ...
            bypass_quantum=bypass_quantum, encoding=encoding,
        )
        ...
        print(
            f"[QuantumAdapter] n_qubits={n_qubits}, n_layers={n_layers}  "
...
def make_model(cfg, num_class, camera_num, view_num,
               ...
               bypass_quantum: bool = False, encoding: str = "angle"):
    """
    ...
    Args:
        ...
        encoding       : 'angle' (default) or 'dense_angle' (2 features/qubit).
