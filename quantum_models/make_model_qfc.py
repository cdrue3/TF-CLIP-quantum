...
- QuantumTemporalAgg replaces the mean-pool temporal aggregation in the primary path:
      img_feature.view(B, T, 768).mean(1)   →   self.qfc(img_feature.view(B, T, 768))
...
from quantum_models.angle.quantum_frame_correlation import QuantumFrameCorrelation
...
class build_transformer(nn.Module):
    ...
    def __init__(self, num_classes, camera_num, view_num, cfg,
        ...
        # ------------------------------------------------------------------ #
        self.qfc = QuantumFrameCorrelation(
        ...
        print(
            f"[QFC] n_qubits={n_qubits}, n_layers={n_layers}, seq_len={cfg.INPUT.SEQ_LEN}  "
    ...
    def forward(self, x=None, get_image=False, cam_label=None, view_label=None,
        ...
        if self.model_name == 'RN50':
            ...
            # TQA replaces .mean(1); bypass_quantum=True gives plain mean-pool.
            img_feature      = self.qfc(img_feature.view(B, T, -1))       # [B, 768]
