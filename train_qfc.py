...
from quantum_models.make_model_qfc import make_model
...
if __name__ == '__main__':
    ...
    logger.info(
        f"[QFC_LR] tqa pre_net/qlayer {TQA_LR_FACTOR}× "
        f"(LR={cfg.SOLVER.STAGE2.BASE_LR * TQA_LR_FACTOR:.2e}, {n_qfc} params); "
