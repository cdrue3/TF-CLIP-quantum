...
from quantum_models.feature_extraction.make_model_qautoencoder import make_model
from loss.quantum_recon_loss import quantum_recon_loss as _qrecon_loss
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="TF-CLIP Quantum AutoEncoder Feature Extractor Training")
    ...
    parser.add_argument(
        ...
        default=0.1,
        type=float,
        help="Weight for quantum autoencoder reconstruction loss (default: 0.1).",
    )
    parser.add_argument(
        "--classical_ablation",
        action="store_true",
    ...
    # Model  (TQA variant)
    # ------------------------------------------------------------------ #
    # Store recon_weight on model so processor.py can apply it during loss computation
    model = make_model(
        cfg,
    ...
    # ------------------------------------------------------------------ #
    model._recon_weight = args.recon_weight
    model._qrecon_loss_fn = _qrecon_loss
