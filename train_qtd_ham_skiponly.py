...
from quantum_models.make_model_qtd_ham_skiponly import make_model
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="TF-CLIP QTD Hamiltonian Encoding Training")
    ...
    logger.info(
        f"[QTD-Ham] n_qubits={args.n_qubits}, n_layers={args.n_layers}, "
