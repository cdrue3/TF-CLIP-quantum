...
from quantum_models.optimisation.make_model_qtemporal_ent import make_model
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="TF-CLIP Entanglement Structure Search Training (DQAS-inspired)")
    ...
    parser.add_argument("--entanglement", default="full",
        choices=["full", "ring", "linear"],
        help="Circuit entanglement topology: full=SEL, ring=nearest-neighbour, linear=chain.")
    parser.add_argument(
        "--classical_ablation",
        action="store_true",
        default=False,
