...
from quantum_models.classification.make_model_qmultihead import make_model
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="TF-CLIP Multi-Head VQC Classifier Training")
    ...
    parser.add_argument("--n_heads", default=4, type=int, help="Number of independent VQC classifier heads (default 4).")
    parser.add_argument(
        "--classical_ablation",
        action="store_true",
        default=False,
